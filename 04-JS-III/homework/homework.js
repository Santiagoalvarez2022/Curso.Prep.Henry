...
function todosIguales(arreglo) {
  ...
  //Escribe tu código aquí  
  var ElemntComparacion= arreglo[1]
  for(x=0 ; x<arreglo.length ; x++) { 
    if (arreglo[x]!==ElemntComparacion){
      return false;
    }
  }
  return true;
